...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 1
    lst=restaurant['reviews']
    ratingslst=[review_rating(rating) for rating in lst]
    return ratingslst
        # END Question 1
...
def restaurant_num_ratings(restaurant):
    ...
    # BEGIN Question 2
    "*** REPLACE THIS LINE ***"
    lst=restaurant_ratings(restaurant)                             #restaurant['reviews']
    num_ratings=len([rating for rating in lst])
    return num_ratings
    # END Question 2
